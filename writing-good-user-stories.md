...
## Purpose
These guidelines help us identify and write effective user stories that are clear, valuable, and actionable. They draw on proven practices from Cohn[^1] and Patton[^2] whilst acknowledging modern realities of distributed teams, continuous delivery, and the need for clarity.

## The essential attributes of a good user story
...
These attributes are often cited as part of the 'INVeSt' criteria, with the missing elements here being _Independent_ and _Negotiable_. But while we should certainly strive to make stories self contained, it is inevitable that some stories will depend on others - software can't be built in any order. 

'Negotiable' was an early agile ideal - "a story is a placeholder for a conversation". But in practice too often ends up being interpreted as stories appearing ready for development with little or no analysis done or even nothing written down at all. That simply results in chaotic kickoffs and stories that fall apart in development, especially in a distributed work environment. So we will define the following supporting criteria
...
As a... &lt;user role&gt; I can/want &lt;do something&gt;, so that &lt;benefit or achievement&gt;

- ✅ "As an investor I want to receive an alert when a price dip is detected so that I can take advantage of a buying opportunity".
- ❌ "As a product manager I want the system to something in order to satisfy a requirement.
...
[^1]: _User Stories Applied_, Mike Cohn, 2004
[^2]: _User Story Mapping_, Jeff Patton, 2014